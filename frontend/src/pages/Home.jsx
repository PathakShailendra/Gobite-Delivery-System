  ...
  return (
    <section className="bg-white">
      <div className="container mx-auto">
        <div
          className={`w-full h-[20vw] bg-blue-100 rounded 
        ...
        >
          ...
          <img
            src={bannerMobile}
            className="w-full mt-10 h-[30vh] mb-10 lg:hidden"
            alt="banner"
          />
        </div>
      </div>

      <div className="container mx-auto px-4 my-36 lg:my-8 grid grid-cols-4 md:grid-cols-8 lg:grid-cols-10 gap-2">
        {loadingCategory
